...
public enum XCConfig {
    ...
    struct Path {
        static let framework: ProjectDescription.Path = .relativeToRoot("Configurations/SecretKeys.xcconfig")
        static let demo: ProjectDescription.Path = .relativeToRoot("Configurations/SecretKeys.xcconfig")
        static let tests: ProjectDescription.Path = .relativeToRoot("Configurations/SecretKeys.xcconfig")
        static let project: ProjectDescription.Path = .relativeToRoot("Configurations/SecretKeys.xcconfig")
//        static func project(_ name: String) -> ProjectDescription.Path {
